...
|---|---|---|---|---|---|
| 1 | **Pak Tono (Ketua KTT)** | Super Admin | `admin@farm.local` | `password` | Akses Penuh (Ternak, User, Laporan, Backup/Restore, Setting) |
| 2 | **Drh. Ahmad** | Petugas Medis | `medis@farm.local` | `password` | Rekam Medis, Cek Kesehatan, Kartu Posyandu, Obat & Stok |
| 3 | **Mas Budi** | Operator Lapangan | `operator@farm.local` | `password` | Input Ternak, Stok Pakan, Catatan Produksi Susu & Daging |
| 4 | **Bpk. Suparjo** | Mitra Peternak | `peternak@farm.local` | `password` | Lihat Data Ternak Sendiri, Kartu Kesehatan & Jadwal Posyandu |
